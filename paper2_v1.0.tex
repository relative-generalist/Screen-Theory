...
\date{[DRAFT v1.0 --- not for circulation]}
...
For dust, nonzero~$J$ drives local area growth; via the
Raychaudhuri equation this determines the null--null components
of the Ricci tensor.
...
$\delta V / A \to \delta\lambda$ (the affine thickness of
the diamond), so to leading order
\begin{equation}
  \frac{d}{d\lambda}\!\left(\frac{4G\,J\,\delta V}{A}\right)
